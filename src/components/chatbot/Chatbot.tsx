...
const Chatbot: React.FC = () => {
  ...
  return (
    <div>
      {/* Chat Icon */}
      <div
        className="fixed bottom-[70px] sm:bottom-10 right-5 w-14 h-14 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full flex items-center justify-center text-white text-sm font-bold cursor-pointer shadow-lg z-50 transition-transform transform hover:scale-110"
        onClick={toggleChat}
      >
        <div className="relative">
          <TbMessageChatbot className="rounded-full w-10 h-10 border-2 border-white" />
